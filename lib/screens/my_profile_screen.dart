...
import 'package:bengaliallinone/screens/webViewScreen.dart';
...
import 'package:bengaliallinone/widgets/rounded_icon_btn.dart';
    ...
    return SingleChildScrollView(
      ...
      children: [
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => WebViewScreen(
                          header: 'OUR WORK',
                          url: 'https://www.matrixnmedia.com/case-studies/',
                        )));
          },
          leading: Container(
            decoration: BoxDecoration(
          ...
          onTap: () {
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => WebViewScreen(
                          header: 'TEAM',
                          url: 'https://www.matrixnmedia.com/team/',
                        )));
          },
          leading: Container(
            decoration: BoxDecoration(
          ...
          onTap: () {
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => WebViewScreen(
                          header: 'BUZZ',
                          url: 'https://www.matrixnmedia.com/buzz/',
                        )));
          },
          leading: Container(
            decoration: BoxDecoration(
          ...
          onTap: () {
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (context) => WebViewScreen(
                          header: 'CONTACT US',
                          url: 'https://www.matrixnmedia.com/contact-us/',
                        )));
          },
          leading: Container(
            decoration: BoxDecoration(
        ...
        ListTile(
          onTap: () {
            Share.share(
              'Check out MATRIX MEDIA\n https://www.matrixnmedia.com',
            );
          },
          leading: Container(
            decoration: BoxDecoration(
